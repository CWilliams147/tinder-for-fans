        ...
        {profiles.length > 0 ? (
          <>
            <div className="profile-display-card">
              ...
              <div className="profile-display-info-container">
                <div className="profile-display-info">
                  <h2>{profiles[currentIndex].name}</h2>
                  <div className="profile-display-info-component">
                    Team: {profiles[currentIndex].team}
                  </div>
                  <div className="profile-display-info-component">
                ...
                <div className="profile-display-buttons">
                  ...
                  <button
                    className="profile-display-next-btn"
